		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Project ci cd",
									"targetURL": "#cominchcapeprojectcicd-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cominchcapeprojectcicd-display": {
								"semanticObject": "cominchcapeprojectcicd",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.inchcape.projectcicd",
									"url": sap.ui.require.toUrl("com/inchcape/projectcicd")
								}
							}
						}
					}
